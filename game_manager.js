...
// Adds a 4096 tile in a random position
GameManager.prototype.add2048Tile = function () {
  if (this.grid.cellsAvailable()) {
    var value = Math.random() < 0.9 ? (Math.random() < 0.1 ? 8 : 2) : 4;
...
// Adds a 4096 tile in a random position
GameManager.prototype.add4096Tile = function () {
  if (this.grid.cellsAvailable()) {
